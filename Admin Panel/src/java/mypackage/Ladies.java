...
class Ladies {
    ...
    Statement st;
    void insertLadies(int id, String name, String description, String price, String amount, String picture) {
            connectToDB();
            String query ="INSERT INTO ladies VALUES("+id+",'"+name+"','"+description+"','"+price+"','"+amount+"','"+picture+"')";    
            try {
