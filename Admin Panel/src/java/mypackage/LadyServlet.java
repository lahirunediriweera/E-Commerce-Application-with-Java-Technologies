 ...
 * @author USER
 */
@WebServlet(name = "LadyServlet", urlPatterns = {"/LadyServlet"})
@MultipartConfig
public class LadyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LadyServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LadyServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("This Item Added Ladies Section Successfully....");
        
        Ladies b = new Ladies();
        b.insertLadies(name,description,price,quantity,imageFileName);
