...
<html>
    ...
    <div class="product-display">
      <table class="product-display-table">
         ...
         <% 
            ...
            <tr>
                ...
                <td>
                    <button onclick="openEditPopup('<%=rs.getInt("gentsId")%>','<%=rs.getString("name")%>', '<%=rs.getString("description")%>', '<%=rs.getInt("price")%>', '<%=rs.getInt("quantity")%>', '<%=rs.getString("image")%>')">Update</button>
                </td>
            </tr>
      ...
      <div id="editPopup" class="editPopup-content">
        ...
        <h2>Edit Gent Items</h2>
        <form action="UpdateGentServlet" method="post">
            <input type="hidden" id="editId" name="gentsId">
